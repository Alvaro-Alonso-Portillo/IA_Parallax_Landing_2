    ...
    return (
        <footer className="bg-[#222222] relative pt-32 pb-12 overflow-hidden px-6 md:px-12">
            <div className="max-w-7xl mx-auto flex flex-col min-h-[80vh] justify-between relative">
                ...
                <div className="flex justify-between items-end mt-24 border-t border-[#F2F1ED]/10 pt-8">
                    <div className="flex gap-8 text-[9px] font-body text-[#899097] tracking-widest uppercase">
